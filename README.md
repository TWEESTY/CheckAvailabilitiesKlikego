...
L'exécution du script est stoppé lors de la fermture de la console Powershell (et donc si vous éteignez l'ordinateur). Il sera donc nécessaire de relancer le script.
